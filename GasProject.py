...
btplot1 = Button(root, text='Рассчитать',         # текст кнопки 
                 ...
                 font="16", command= lambda: do_plot([0,1,2],[5,3,7]))
btplot1.place(x=300, y=750, width=100, height=40)
...
btplot2=Button(root, text="Сумма первых 2ух полей в бокс", command=suum)
btplot2.place(x=100, y=650, width=400, height=40)
